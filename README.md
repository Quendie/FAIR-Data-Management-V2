...
An adapted version of the material has been updated by the same group of creators for the MPG Open Science Ambassadors Meeting 2024. All self-paced training elements remain.

[Jasmin Bauer](https://github.com/Quendie) and [Jens Saak](https://github.com/drittelhacker) have added Example 5 for the presentation of the material at the [Max Planck Institute for Dynamics of Complex Technical Systems](https://www.mpi-magdeburg.mpg.de), as part of their [Love-Data-Week Events 2026](https://indico3.mpi-magdeburg.mpg.de/event/62/).
