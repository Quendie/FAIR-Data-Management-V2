...
Here we could point to the article by our former colleague Yves Grossmann: [https://doi.org/10.5334/dsj-2024-043](https://doi.org/10.5334/dsj-2024-043)
...
There is a SMP catalog in the MPDL RDMO instance that can also be integrated in other RDMO instances. The MPDL is currently also developing additional plugins for easier SMP usage in RDMO under the DFG funded [MAUS project](https://doi.org/10.5334/dsj-2024-043).

We could either state in the task that they should select that catalog, when setting up their example or just point them to it during the meeting. 
:::
