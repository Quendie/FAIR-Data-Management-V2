...
For software and code instead of DMPs you will have **SMP - Software Management Plans**. A helpful article on this can be found here: [https://doi.org/10.5334/dsj-2024-043](https://doi.org/10.5334/dsj-2024-043).
...
There is a SMP catalog in the MPDL RDMO instance that can also be integrated in other RDMO instances. The MPDL is currently also developing additional plugins for an easier SMP usage in RDMO under the DFG funded [MAUS project](https://doi.org/10.5334/dsj-2024-043).
