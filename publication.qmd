...
::: callout-warning
## Legal aspects specific to software 

Research software and code have different legal aspects that are discussed on the [Good Scientific Practice for Research Software Engineering Website](https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/legal/).

Two important take aways for researchers working within the MPG are:
 
- Software generally belongs to the Max Planck Society e.V.
- If copyright agreements (especially licenses) are made, the Managing Director or a person with the authority to represent them must be involved
:::
...
Is there anything to consider for a code/software availability statement that differs from a "Data Availability Statement"? 
Is it better to combine the two aspects or separate them? 
::: -->
...
::: {.callout-important collapse="true"}
## Solution: Example 5 (\~ 5 minutes)

1.  Yes, there is a meta data field saying that the data set "is supplement to" the Journal article.

2.  Yes, it does. It even specifies various details and points to additional intermediate result data.

3.  As the first subsection called "Data and code availability" at the beginning of the "Numerical experiments" section right after the description of the hardware environment  used.
:::
...
There are several licenses out there, as e.g. [Creative Commons](https://creativecommons.org/) (data), [MIT](https://opensource.org/license/mit) (software), [Apache](https://www.apache.org/licenses/) (software), [GNU GPL](https://www.gnu.org/licenses/gpl-3.0.html) (software), [Open Data Commons](https://opendatacommons.org/) (data) and it ultimately is your responsibility (together with your PI) to pick one. If you have no advise and you do not want to read through all licenses out there, the Creative Commons licences are usually a save choice (see box below). However, there is also the legal department of the MP headquarters for receiving advice. As rule of thumb, you may want to remember to go with the least restrictive license to maximize your data's reuse potential. A recent article gives the following recommendations[^3]:
...
::: callout-note
## Excursion: License and Copyright for software

Here is a helpful website for understanding copyright vs. copyleft and GNU GPL: [https://opensource.com/resources/what-is-copyleft](https://opensource.com/resources/what-is-copyleft). In general the GNU GPL represents a license for software where everyone is permitted to copy and distribute, while not allowed to change.

Further resources on license compatibility [https://dwheeler.com/essays/floss-license-slide.html](https://dwheeler.com/essays/floss-license-slide.html), deciding on a license [https://choosealicense.com/](https://choosealicense.com/) and licenses summarized at-a-glance [https://www.tldrlegal.com/](https://www.tldrlegal.com/).
:::
...
::: {.callout-important collapse="true"}
## Solution: Example 5 (\~ 2 minutes)

1.  Yes.

2.  That depends on what is reused. [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) for the data set and [GPL v2](https://www.gnu.de/documents/gpl-2.0.de.html) for the code.
:::
...
1.  Yes, via DOI https://doi.org/10.5281/zenodo.2563874.
...
I think the PID section works quite well for the software section. I just noticed the "PIDs and Citation" seciton in the GWP for RSE Document: [https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/cite/](https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/cite/) 
It might make sense to refer to that for a deeper insight. We could also do an excursion on .cff in code repositories, since it is something easily adoptable and would fit this chapter overall. 
::: -->
...
There is a section on this in the GWP for RSE as well: [https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/repos/](https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/repos/)

It would be nice to give a short overview of how to best use (or not use) GitHub as well as a reference to Software Heritage. 
::: -->

For software repositories, again, others aspects are involved and are discussed here: [https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/repos/](https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/repos/)
