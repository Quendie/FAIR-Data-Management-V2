...
While the metadata section is roughly transferable to software/code an important point missing from the documentation aspect for software specifically are dependencies, requirements or whole virtual environments.

Helpful resources on documentation [https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/reprod/](https://gwp-rse-ff130b.pages.gwdg.de/en/faqs/reprod/) and environments [https://book.the-turing-way.org/reproducible-research/renv/](https://book.the-turing-way.org/reproducible-research/renv/). 

Also this website on good practises could be of help: [S3 School 2026 Lectures](https://s3-school.github.io/s3-2026-lectures/2.1-coding-environment-good-practices/2.1.1-coding-environment-IDE/).

This topic could be covering an entire workshop itself. Also it can span multiple skill levels that makes it difficult to cover all levels of coders within this workshop. Therefore we are limiting this excursion to point to those further resources. 
::: 
...
As already mentioned this README structure and template does not work well for software/code especially with the additional component of the README being usually the "front page" and contact point for users on platforms like GitHub. 
There are many resources on the topic and README templates for software available under [https://github.com/matiassingers/awesome-readme?tab=readme-ov-file](https://github.com/matiassingers/awesome-readme?tab=readme-ov-file) 

For this workshop, we will follow a simple template structure from [Make a README](https://www.makeareadme.com/).
...
Notes on software README:

-   The code zip files for python and Matlab code have their respective README files. Would you combine them to one README or also stay with two?
-   README.md for the python code is close to the template structure. 
-   When reading the README files did you feel you could start working with the code easily? Would you do something differently?
-   Find the filled out README template for example 5 [here](/Example5_READMETemplateSoftware.md)
...
::: callout-note
## Excursion: Linters for coding

There are tools that can help you avoiding common coding mistakes - called linters. Check out this website for more information: [https://github.com/caramelomartins/awesome-linters](https://github.com/caramelomartins/awesome-linters)
